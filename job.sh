...
#SBATCH -o qout_log/app/qout_1n_64.256.%j # std::out is saved here
#SBATCH -e qout_log/app/qout_1n_64.256.%j 
...
srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} 55213440
