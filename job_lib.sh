...
#SBATCH -o qout_log/lib/qout_4n_64.256.%j # std::out is saved here
#SBATCH -e qout_log/lib/qout_4n_64.256.%j 
...
srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} data/dataset_568k_metadata /pscratch/sd/y/yll6162/FS_2M_8/dataset_568k_metadata_lib_baseline_test_all.nc
