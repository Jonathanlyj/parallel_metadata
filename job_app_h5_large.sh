...
#SBATCH -o qout_log/app_h5_large/qout_1n_1.256.%j # std::out is saved here
#SBATCH -e qout_log/app_h5_large/qout_1n_1.256.%j 

#SBATCH --mail-type=end,fail
#SBATCH --mail-user=youjia@northwestern.edu

if test "x$SLURM_NTASKS_PER_NODE" = x ; then #number of cores per node
   SLURM_NTASKS_PER_NODE=1 # 256 max
fi
...
EXE=/global/homes/y/yll6162/parallel_metadata/h5_baseline_test_all_large
