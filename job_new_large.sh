...
#SBATCH -o qout_log/new/qout_large_8n_64.256.%j # std::out is saved here
#SBATCH -e qout_log/new/qout_large_8n_64.256.%j 
...
SB_EXE=/tmp/${USER}_new_format_test_all #tmp all users shared
sbcast -v ${EXE} ${SB_EXE} #executable copy to this position

export PNETCDF_HINTS="nc_hash_size_dim=16384;nc_hash_size_var=16384"
srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} data/dataset_5m_metadata /pscratch/sd/y/yll6162/FS_2M_64/dataset_5m_metadata_new_format_test_all.pnc
