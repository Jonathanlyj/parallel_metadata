...
#SBATCH -o qout_log/lib/qout_large_4n_64.256.%j # std::out is saved here
#SBATCH -e qout_log/lib/qout_large_4n_64.256.%j 
...
# EXE=/global/homes/y/yll6162/pdsw/parallel_metadata/lib_baseline_read_test_all
EXE=/global/homes/y/yll6162/pdsw/parallel_metadata/lib_baseline_test_all
...
SB_EXE=/tmp/${USER}_lib_baseline_test_all #tmp all users shared
...
srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} data/dataset_5m_metadata /pscratch/sd/y/yll6162/FS_2M_8/dataset_5m_metadata_lib_baseline_test_all.nc
