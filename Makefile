PNETCDF_DIR=/path/to/PnetCDF/pnetcdf-install
PNETCDF_DIR_LIBBASE=/path/to/PnetCDF/pnetcdf-lib-install
PNETCDF_DIR_LIBSORT=/path/to/PnetCDF/pnetcdf-sort-install
PNETCDF_DIR_FORMAT=/path/to/PnetCDF/pnetcdf-format-install
