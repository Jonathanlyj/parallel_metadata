...
# PNETCDF_DIR_LIB=/files2/scratch/yll6162/PnetCDF-meta/PnetCDF-sort-install
...
PNETCDF_DIR_LIB=$(PNETCDF_DIR_LIBSORT)
CC = mpicc
H5CC = h5pcc
...
SRCS = baseline_ex1.c baseline_ncx_app.c baseline_ncx_lib.c app_baseline_test_all.c baseline_test.c lib_level_baseline_test_shared.c lib_level_baseline_test_read.c lib_level_baseline_test_dup_name.c lib_baseline_test_all.c h5_baseline_test_all.c h5_baseline_test_all_large.c
OBJS = $(SRCS:.c=.o)
...
all: baseline_test baseline_ex1 app_baseline_test_all pnc_consist_check $(LIB_PROGRAMS) h5_baseline_test_all_large

%.o: %.c
	$(CC) $(CFLAGS) $(INCLUDES) -c $< -o $@

lib_%.o: lib_level%.c $(PNETCDF_DIR_LIB)/lib/libpnetcdf.a
	$(CC) $(CFLAGS) $(INCLUDES_LIB) -c $< -o $@

new_format_%.o: new_format_%.c  $(PNETCDF_DIR_FORMAT)/lib/libpnetcdf.a
	$(CC) $(CFLAGS) $(INCLUDES_FORMAT) -c $< -o $@

new_format_test_all.o: new_format_test_all.c  $(PNETCDF_DIR_FORMAT)/lib/libpnetcdf.a
	$(CC) $(CFLAGS) $(INCLUDES_FORMAT) -c $< -o $@
...
lib_baseline_test_all: lib_baseline_test_all.o baseline_ncx_lib.o $(PNETCDF_DIR_LIB)/lib/libpnetcdf.a
	$(CC) $(CFLAGS) $(INCLUDES_LIB) $(LFLAGS_LIB) -o $@ $^ $(LIBS)
...
clean:
	rm -f $(OBJS)baseline_ex1 app_baseline_test_all pnc_consist_check lib_level_baseline_test_shared lib_level_baseline_test_read lib_level_baseline_test_dup_name lib_baseline_test_all h5_baseline_test_all new_format_create_simple h5_baseline_test_all_large
base: baseline_test baseline_ex1 app_baseline_test_all pnc_consist_check
lib: $(LIB_PROGRAMS)
h5: h5_baseline_test_all h5_baseline_test_all_large
