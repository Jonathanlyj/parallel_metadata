...
#SBATCH -o qout_log/app_h5/qout_1n_16.256.%j # std::out is saved here
#SBATCH -e qout_log/app_h5/qout_1n_16.256.%j 
...
EXE=/global/homes/y/yll6162/pdsw/parallel_metadata/h5_baseline_test_all
...
SB_EXE=/tmp/${USER}_h5_baseline_test_all #tmp all users shared
sbcast -v ${EXE} ${SB_EXE} #executable copy to this position


srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} data/dataset_568k_metadata /pscratch/sd/y/yll6162/FS_2M_64/dataset_568k_metadata_h5_baseline_test_all.h5
