...
#SBATCH -o qout_log/app/qout_read_large_1n_64.256.%j # std::out is saved here
#SBATCH -e qout_log/app/qout_read_large_1n_64.256.%j 
...
srun -n $NP -c $((256/$SLURM_NTASKS_PER_NODE)) --cpu_bind=cores ${SB_EXE} /pscratch/sd/y/yll6162/FS_2M_8/dataset_5m_metadata_app_baseline_test_all.nc
