...
#SBATCH -C cpu
#SBATCH --qos=debug
#SBATCH -o qout_log/new/qout_1n_16.256.%j # std::out is saved here
#SBATCH -e qout_log/new/qout_1n_16.256.%j 
...
# EXE=/global/homes/y/yll6162/parallel_metadata/new_format_read_test_all
# EXE=/global/homes/y/yll6162/parallel_metadata/new_format_create_simple
